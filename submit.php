...
if(isset($_POST['name']) && isset($_POST['email']) && isset($_POST['mobile']) && isset($_POST['comment'])){
	...
	$msg="Thank you,Our Team will be conatact you shortly.";
	...
	$mail->SMTPSecure="tls";
	$mail->SMTPAuth=true;
	$mail->Username="shivgaikwad03@gmail.com";
	$mail->Password="8108445850";
	$mail->SetFrom("shivgaikwad03@gmail.com");
	$mail->addAddress("shivgaikwad03@gmail.com");
	$mail->IsHTML(true);
