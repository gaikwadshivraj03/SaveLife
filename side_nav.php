...
<ul class="nav nav-stacked">
	<li><a href="bloodinfo.php"><i class="fa fa-envelope fa-lg"></i> Inbox <?php echo $mes;?></a></li>
	<li><a href="bloodrequest.php"><i class="fa fa-search fa-lg"></i>Search Donors</a></li>
	<li><a href="abs.php"><i class="fa fa-users fa-lg text-success"></i> Active Donors</a></li>
	<li><a href="hprofile.php"><i class="fa fa-users fa-lg text-danger"></i> Not Active Donors</a></li>
