...
<ul class="nav nav-stacked">
	...
	<li><a href="abs.php"><i class="fa fa-search fa-lg"></i>Available Blood</a></li>
	<li><a href="resgister.php"><i class="fa fa-users fa-lg text-success"></i> Register</a></li>
	<li><a href="login.php"><i class="fa fa-users fa-lg text-danger"></i> Login</a></li>
